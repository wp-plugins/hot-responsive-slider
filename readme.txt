...
Hot Responsive Slider allows you to create responsive, touch-friendly image sliders and insert them easily into your posts with shortcodes.
...
Hot Responsive Slider by [HotThemes](http://hot-themes.com/ "HotThemes") is based on jQuery. The sliders you create will look great on mobile devices and they will fit into the screen automatically. Furthermore, on all touch-screens user can change images with finger gestures, such as swiping or tapping.
...
1. Sample screen shot of the Hot Responsive Slider with all elements enabled.
2. Screen shot of the Hot Responsive Slider parameters.
